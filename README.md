...
<details>
  <summary>프리코스 3주 차 일정 (25.10.28 ~ 25.11.03)</summary>

- 25.10.28.(화) README 작성
- 25.10.29.(수) 로또 기능 관련 기능 개발
- 25.10.30.(목) 로또 미션 구현
- 25.10.31.(금) MVC 구조 기반 재설계 및 모델 구현
- 25.11.01.(토) 컨트롤러 개발 및 로또 미션 재구현
- 25.11.02.(일) 코드 리팩터링, 상수화, 파일 정리
- 25.11.03.(월) 미션 제출 및 회고록 작성
